...
const HachureArrow = () => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M 200 10 C 160 12, 80 30, 18 72" stroke="#2d2d2d" strokeWidth="1.6" strokeLinecap="round" fill="none" />
    <path d="M 18 72 L 28 62 M 18 72 L 30 76" stroke="#2d2d2d" strokeWidth="1.6" strokeLinecap="round" />
    {[
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          borderRadius: 16,
          background: '#eceef3',
          boxShadow: '5px 5px 12px #d1d3da, -5px -5px 12px #ffffff',
          ...
          <div style={{
            ...
            width: 1.5,
            height: 18,
            background: 'linear-gradient(to bottom, rgba(76,175,114,0.5), transparent)',
          }} />

          {/* Click-line separator */}
          <div style={{
            position: 'absolute',
            top: 18,
            left: 5,
          ...
          >
              ...
              <h1 className="leading-[1.0] tracking-tight" style={{ fontSize: 'clamp(46px, 5.5vw, 78px)', fontWeight: 900 }}>
                ...
                <span
                  ...
                  style={{
                    ...
                    textShadow: '3px 3px 6px #d1d3da, -2px -2px 5px #ffffff, 0 1px 0px rgba(255,255,255,0.9)',
            ...
            <div className="flex items-center gap-3 mt-1 flex-wrap">
              <button
                ...
                style={{ background: '#eceef3', color: '#4caf72', boxShadow: '4px 4px 10px #d1d3da, -4px -4px 10px #ffffff', border: '1px solid rgba(255,255,255,0.6)' }}
                onMouseEnter={e => { e.currentTarget.style.boxShadow = 'inset 3px 3px 7px #c8cad1, inset -3px -3px 7px #ffffff' }}
              ...
              <button
                className="flex items-center gap-2 px-7 h-[46px] rounded-full font-semibold text-sm tracking-wide transition-all duration-300"
                style={{ background: '#eceef3', color: '#6b7280', boxShadow: '4px 4px 10px #d1d3da, -4px -4px 10px #ffffff', border: '1px solid rgba(255,255,255,0.6)' }}
                onMouseEnter={e => { e.currentTarget.style.boxShadow = 'inset 3px 3px 7px #c8cad1, inset -3px -3px 7px #ffffff'; e.currentTarget.style.color = '#4caf72' }}
                onMouseLeave={e => { e.currentTarget.style.boxShadow = '4px 4px 10px #d1d3da, -4px -4px 10px #ffffff'; e.currentTarget.style.color = '#6b7280' }}
              >
                Contact Me
              </button>
            </div>
        ...
        >
          <div className="flex items-stretch gap-4 flex-wrap">
            <div
              ...
              style={{ background: '#eceef3', boxShadow: '6px 6px 14px #d1d3da, -6px -6px 14px #ffffff', border: '1px solid rgba(255,255,255,0.7)', minWidth: 140 }}
            >
